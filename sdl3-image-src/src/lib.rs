...
/// Revision
pub const REVISION: &str = "SDL_image-release-3.2.6";

/// Version part of the revision
pub const VERSION: &str = "3.2.6";

/// Tag part of the revision
pub const REVISION_TAG: &str = "release-3.2.6";
...
pub const REVISION_HASH: &str = "gd78dd654";
