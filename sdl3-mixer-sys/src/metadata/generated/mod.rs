...
pub const PROPERTIES: &[&Property] = &[
    ...
    &mixer::METADATA_MIX_PROP_AUDIO_LOAD_IGNORE_LOOPS_BOOLEAN,
    ...
    &mixer::METADATA_MIX_PROP_PLAY_START_ORDER_NUMBER,
    ...
    &mixer::METADATA_MIX_PROP_PLAY_HALT_WHEN_EXHAUSTED_BOOLEAN,
];
