...
impl SDL_GLProfile {
    ...
    #[inline(always)]
    pub const fn new(value: Sint32) -> Self {
        Self(value)
    }
}
...
pub const SDL_PROP_WINDOW_CREATE_CONSTRAIN_POPUP_BOOLEAN: *const ::core::ffi::c_char =
    c"SDL.window.create.constrain_popup".as_ptr();
