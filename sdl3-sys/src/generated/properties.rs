...
impl ::core::cmp::PartialEq<SDL_PropertiesID> for Uint32 {
    #[inline(always)]
    fn eq(&self, other: &SDL_PropertiesID) -> bool {
        self == &other.0
    }
}
...
impl ::core::fmt::Display for SDL_PropertiesID {
    #[inline(always)]
...
impl SDL_PropertiesID {
    /// Initialize a `SDL_PropertiesID` from a raw value.
    /// # Safety
...
impl sdl3_sys::metadata::GroupMetadata for SDL_PropertiesID {
...
impl ::core::cmp::PartialEq<SDL_PropertyType> for ::core::ffi::c_int {
    #[inline(always)]
    fn eq(&self, other: &SDL_PropertyType) -> bool {
        self == &other.0
    }
}
...
impl SDL_PropertyType {
    /// Initialize a `SDL_PropertyType` from a raw value.
    /// # Safety
    /// The value should be valid for this type
    #[inline(always)]
...
#[cfg(feature = "metadata")]
impl sdl3_sys::metadata::GroupMetadata for SDL_PropertyType {
    const GROUP_METADATA: &'static sdl3_sys::metadata::Group =
...
pub const SDL_PROP_NAME_STRING: *const ::core::ffi::c_char = c"SDL.name".as_ptr();
...
unsafe extern "C" {
    ...
    ///
    /// ## Thread safety
    /// It is safe to call this function from any thread. This
