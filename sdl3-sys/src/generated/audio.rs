...
unsafe extern "C" {
    ...
    /// ## Availability
    /// This function is available since SDL 3.2.0.
    pub safe fn SDL_IsAudioDevicePhysical(devid: SDL_AudioDeviceID) -> ::core::primitive::bool;
}
...
unsafe extern "C" {
    ...
    /// ## Availability
    /// This function is available since SDL 3.2.0.
    pub safe fn SDL_IsAudioDevicePlayback(devid: SDL_AudioDeviceID) -> ::core::primitive::bool;
}
...
unsafe extern "C" {
    ...
    /// ## Availability
    /// This function is available since SDL 3.2.0.
    pub safe fn SDL_GetSilenceValueForFormat(format: SDL_AudioFormat) -> ::core::ffi::c_int;
}
