...
/// | ------------------- | --------------- | ----------- |
/// | [`SDL_EventType::FIRST`] | [`SDL_EVENT_FIRST`] | Unused (do not remove) |
/// | [`SDL_EventType::QUIT`] | [`SDL_EVENT_QUIT`] | User-requested quit |
/// | [`SDL_EventType::TERMINATING`] | [`SDL_EVENT_TERMINATING`] | The application is being terminated by the OS. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::LOW_MEMORY`] | [`SDL_EVENT_LOW_MEMORY`] | The application is low on memory, free memory if possible. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::WILL_ENTER_BACKGROUND`] | [`SDL_EVENT_WILL_ENTER_BACKGROUND`] | The application is about to enter the background. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::DID_ENTER_BACKGROUND`] | [`SDL_EVENT_DID_ENTER_BACKGROUND`] | The application did enter the background and may not get CPU for some time. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::WILL_ENTER_FOREGROUND`] | [`SDL_EVENT_WILL_ENTER_FOREGROUND`] | The application is about to enter the foreground. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::DID_ENTER_FOREGROUND`] | [`SDL_EVENT_DID_ENTER_FOREGROUND`] | The application is now interactive. This event must be handled in a callback set with SDL_AddEventWatch(). (...) |
/// | [`SDL_EventType::LOCALE_CHANGED`] | [`SDL_EVENT_LOCALE_CHANGED`] | The user's locale preferences have changed. |
/// | [`SDL_EventType::SYSTEM_THEME_CHANGED`] | [`SDL_EVENT_SYSTEM_THEME_CHANGED`] | The system theme changed |
/// | [`SDL_EventType::DISPLAY_ORIENTATION`] | [`SDL_EVENT_DISPLAY_ORIENTATION`] | Display orientation has changed to data1 |
/// | [`SDL_EventType::DISPLAY_ADDED`] | [`SDL_EVENT_DISPLAY_ADDED`] | Display has been added to the system |
/// | [`SDL_EventType::DISPLAY_REMOVED`] | [`SDL_EVENT_DISPLAY_REMOVED`] | Display has been removed from the system |
/// | [`SDL_EventType::DISPLAY_MOVED`] | [`SDL_EVENT_DISPLAY_MOVED`] | Display has changed position |
/// | [`SDL_EventType::DISPLAY_DESKTOP_MODE_CHANGED`] | [`SDL_EVENT_DISPLAY_DESKTOP_MODE_CHANGED`] | Display has changed desktop mode |
/// | [`SDL_EventType::DISPLAY_CURRENT_MODE_CHANGED`] | [`SDL_EVENT_DISPLAY_CURRENT_MODE_CHANGED`] | Display has changed current mode |
/// | [`SDL_EventType::DISPLAY_CONTENT_SCALE_CHANGED`] | [`SDL_EVENT_DISPLAY_CONTENT_SCALE_CHANGED`] | Display has changed content scale |
/// | [`SDL_EventType::DISPLAY_FIRST`] | [`SDL_EVENT_DISPLAY_FIRST`] |  |
/// | [`SDL_EventType::DISPLAY_LAST`] | [`SDL_EVENT_DISPLAY_LAST`] |  |
/// | [`SDL_EventType::WINDOW_SHOWN`] | [`SDL_EVENT_WINDOW_SHOWN`] | Window has been shown |
/// | [`SDL_EventType::WINDOW_HIDDEN`] | [`SDL_EVENT_WINDOW_HIDDEN`] | Window has been hidden |
/// | [`SDL_EventType::WINDOW_EXPOSED`] | [`SDL_EVENT_WINDOW_EXPOSED`] | Window has been exposed and should be redrawn, and can be redrawn directly from event watchers for this event |
/// | [`SDL_EventType::WINDOW_MOVED`] | [`SDL_EVENT_WINDOW_MOVED`] | Window has been moved to data1, data2 |
/// | [`SDL_EventType::WINDOW_RESIZED`] | [`SDL_EVENT_WINDOW_RESIZED`] | Window has been resized to data1xdata2 |
/// | [`SDL_EventType::WINDOW_PIXEL_SIZE_CHANGED`] | [`SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED`] | The pixel size of the window has changed to data1xdata2 |
/// | [`SDL_EventType::WINDOW_METAL_VIEW_RESIZED`] | [`SDL_EVENT_WINDOW_METAL_VIEW_RESIZED`] | The pixel size of a Metal view associated with the window has changed |
/// | [`SDL_EventType::WINDOW_MINIMIZED`] | [`SDL_EVENT_WINDOW_MINIMIZED`] | Window has been minimized |
/// | [`SDL_EventType::WINDOW_MAXIMIZED`] | [`SDL_EVENT_WINDOW_MAXIMIZED`] | Window has been maximized |
/// | [`SDL_EventType::WINDOW_RESTORED`] | [`SDL_EVENT_WINDOW_RESTORED`] | Window has been restored to normal size and position |
/// | [`SDL_EventType::WINDOW_MOUSE_ENTER`] | [`SDL_EVENT_WINDOW_MOUSE_ENTER`] | Window has gained mouse focus |
/// | [`SDL_EventType::WINDOW_MOUSE_LEAVE`] | [`SDL_EVENT_WINDOW_MOUSE_LEAVE`] | Window has lost mouse focus |
/// | [`SDL_EventType::WINDOW_FOCUS_GAINED`] | [`SDL_EVENT_WINDOW_FOCUS_GAINED`] | Window has gained keyboard focus |
/// | [`SDL_EventType::WINDOW_FOCUS_LOST`] | [`SDL_EVENT_WINDOW_FOCUS_LOST`] | Window has lost keyboard focus |
/// | [`SDL_EventType::WINDOW_CLOSE_REQUESTED`] | [`SDL_EVENT_WINDOW_CLOSE_REQUESTED`] | The window manager requests that the window be closed |
/// | [`SDL_EventType::WINDOW_HIT_TEST`] | [`SDL_EVENT_WINDOW_HIT_TEST`] | Window had a hit test that wasn't SDL_HITTEST_NORMAL |
/// | [`SDL_EventType::WINDOW_ICCPROF_CHANGED`] | [`SDL_EVENT_WINDOW_ICCPROF_CHANGED`] | The ICC profile of the window's display has changed |
/// | [`SDL_EventType::WINDOW_DISPLAY_CHANGED`] | [`SDL_EVENT_WINDOW_DISPLAY_CHANGED`] | Window has been moved to display data1 |
/// | [`SDL_EventType::WINDOW_DISPLAY_SCALE_CHANGED`] | [`SDL_EVENT_WINDOW_DISPLAY_SCALE_CHANGED`] | Window display scale has been changed |
/// | [`SDL_EventType::WINDOW_SAFE_AREA_CHANGED`] | [`SDL_EVENT_WINDOW_SAFE_AREA_CHANGED`] | The window safe area has been changed |
/// | [`SDL_EventType::WINDOW_OCCLUDED`] | [`SDL_EVENT_WINDOW_OCCLUDED`] | The window has been occluded |
/// | [`SDL_EventType::WINDOW_ENTER_FULLSCREEN`] | [`SDL_EVENT_WINDOW_ENTER_FULLSCREEN`] | The window has entered fullscreen mode |
/// | [`SDL_EventType::WINDOW_LEAVE_FULLSCREEN`] | [`SDL_EVENT_WINDOW_LEAVE_FULLSCREEN`] | The window has left fullscreen mode |
/// | [`SDL_EventType::WINDOW_DESTROYED`] | [`SDL_EVENT_WINDOW_DESTROYED`] | The window with the associated ID is being or has been destroyed. If this message is being handled (...) |
/// | [`SDL_EventType::WINDOW_HDR_STATE_CHANGED`] | [`SDL_EVENT_WINDOW_HDR_STATE_CHANGED`] | Window HDR properties have changed |
/// | [`SDL_EventType::WINDOW_FIRST`] | [`SDL_EVENT_WINDOW_FIRST`] |  |
/// | [`SDL_EventType::WINDOW_LAST`] | [`SDL_EVENT_WINDOW_LAST`] |  |
/// | [`SDL_EventType::KEY_DOWN`] | [`SDL_EVENT_KEY_DOWN`] | Key pressed |
/// | [`SDL_EventType::KEY_UP`] | [`SDL_EVENT_KEY_UP`] | Key released |
/// | [`SDL_EventType::TEXT_EDITING`] | [`SDL_EVENT_TEXT_EDITING`] | Keyboard text editing (composition) |
/// | [`SDL_EventType::TEXT_INPUT`] | [`SDL_EVENT_TEXT_INPUT`] | Keyboard text input |
/// | [`SDL_EventType::KEYMAP_CHANGED`] | [`SDL_EVENT_KEYMAP_CHANGED`] | Keymap changed due to a system event such as an (...) |
/// | [`SDL_EventType::KEYBOARD_ADDED`] | [`SDL_EVENT_KEYBOARD_ADDED`] | A new keyboard has been inserted into the system |
/// | [`SDL_EventType::KEYBOARD_REMOVED`] | [`SDL_EVENT_KEYBOARD_REMOVED`] | A keyboard has been removed |
/// | [`SDL_EventType::TEXT_EDITING_CANDIDATES`] | [`SDL_EVENT_TEXT_EDITING_CANDIDATES`] | Keyboard text editing candidates |
/// | [`SDL_EventType::MOUSE_MOTION`] | [`SDL_EVENT_MOUSE_MOTION`] | Mouse moved |
/// | [`SDL_EventType::MOUSE_BUTTON_DOWN`] | [`SDL_EVENT_MOUSE_BUTTON_DOWN`] | Mouse button pressed |
/// | [`SDL_EventType::MOUSE_BUTTON_UP`] | [`SDL_EVENT_MOUSE_BUTTON_UP`] | Mouse button released |
/// | [`SDL_EventType::MOUSE_WHEEL`] | [`SDL_EVENT_MOUSE_WHEEL`] | Mouse wheel motion |
/// | [`SDL_EventType::MOUSE_ADDED`] | [`SDL_EVENT_MOUSE_ADDED`] | A new mouse has been inserted into the system |
/// | [`SDL_EventType::MOUSE_REMOVED`] | [`SDL_EVENT_MOUSE_REMOVED`] | A mouse has been removed |
/// | [`SDL_EventType::JOYSTICK_AXIS_MOTION`] | [`SDL_EVENT_JOYSTICK_AXIS_MOTION`] | Joystick axis motion |
/// | [`SDL_EventType::JOYSTICK_BALL_MOTION`] | [`SDL_EVENT_JOYSTICK_BALL_MOTION`] | Joystick trackball motion |
/// | [`SDL_EventType::JOYSTICK_HAT_MOTION`] | [`SDL_EVENT_JOYSTICK_HAT_MOTION`] | Joystick hat position change |
/// | [`SDL_EventType::JOYSTICK_BUTTON_DOWN`] | [`SDL_EVENT_JOYSTICK_BUTTON_DOWN`] | Joystick button pressed |
/// | [`SDL_EventType::JOYSTICK_BUTTON_UP`] | [`SDL_EVENT_JOYSTICK_BUTTON_UP`] | Joystick button released |
/// | [`SDL_EventType::JOYSTICK_ADDED`] | [`SDL_EVENT_JOYSTICK_ADDED`] | A new joystick has been inserted into the system |
/// | [`SDL_EventType::JOYSTICK_REMOVED`] | [`SDL_EVENT_JOYSTICK_REMOVED`] | An opened joystick has been removed |
/// | [`SDL_EventType::JOYSTICK_BATTERY_UPDATED`] | [`SDL_EVENT_JOYSTICK_BATTERY_UPDATED`] | Joystick battery level change |
/// | [`SDL_EventType::JOYSTICK_UPDATE_COMPLETE`] | [`SDL_EVENT_JOYSTICK_UPDATE_COMPLETE`] | Joystick update is complete |
/// | [`SDL_EventType::GAMEPAD_AXIS_MOTION`] | [`SDL_EVENT_GAMEPAD_AXIS_MOTION`] | Gamepad axis motion |
/// | [`SDL_EventType::GAMEPAD_BUTTON_DOWN`] | [`SDL_EVENT_GAMEPAD_BUTTON_DOWN`] | Gamepad button pressed |
/// | [`SDL_EventType::GAMEPAD_BUTTON_UP`] | [`SDL_EVENT_GAMEPAD_BUTTON_UP`] | Gamepad button released |
/// | [`SDL_EventType::GAMEPAD_ADDED`] | [`SDL_EVENT_GAMEPAD_ADDED`] | A new gamepad has been inserted into the system |
/// | [`SDL_EventType::GAMEPAD_REMOVED`] | [`SDL_EVENT_GAMEPAD_REMOVED`] | A gamepad has been removed |
/// | [`SDL_EventType::GAMEPAD_REMAPPED`] | [`SDL_EVENT_GAMEPAD_REMAPPED`] | The gamepad mapping was updated |
/// | [`SDL_EventType::GAMEPAD_TOUCHPAD_DOWN`] | [`SDL_EVENT_GAMEPAD_TOUCHPAD_DOWN`] | Gamepad touchpad was touched |
/// | [`SDL_EventType::GAMEPAD_TOUCHPAD_MOTION`] | [`SDL_EVENT_GAMEPAD_TOUCHPAD_MOTION`] | Gamepad touchpad finger was moved |
/// | [`SDL_EventType::GAMEPAD_TOUCHPAD_UP`] | [`SDL_EVENT_GAMEPAD_TOUCHPAD_UP`] | Gamepad touchpad finger was lifted |
/// | [`SDL_EventType::GAMEPAD_SENSOR_UPDATE`] | [`SDL_EVENT_GAMEPAD_SENSOR_UPDATE`] | Gamepad sensor was updated |
/// | [`SDL_EventType::GAMEPAD_UPDATE_COMPLETE`] | [`SDL_EVENT_GAMEPAD_UPDATE_COMPLETE`] | Gamepad update is complete |
/// | [`SDL_EventType::GAMEPAD_STEAM_HANDLE_UPDATED`] | [`SDL_EVENT_GAMEPAD_STEAM_HANDLE_UPDATED`] | Gamepad Steam handle has changed |
/// | [`SDL_EventType::FINGER_DOWN`] | [`SDL_EVENT_FINGER_DOWN`] |  |
/// | [`SDL_EventType::FINGER_UP`] | [`SDL_EVENT_FINGER_UP`] |  |
/// | [`SDL_EventType::FINGER_MOTION`] | [`SDL_EVENT_FINGER_MOTION`] |  |
/// | [`SDL_EventType::CLIPBOARD_UPDATE`] | [`SDL_EVENT_CLIPBOARD_UPDATE`] | The clipboard or primary selection changed |
/// | [`SDL_EventType::DROP_FILE`] | [`SDL_EVENT_DROP_FILE`] | The system requests a file open |
/// | [`SDL_EventType::DROP_TEXT`] | [`SDL_EVENT_DROP_TEXT`] | text/plain drag-and-drop event |
/// | [`SDL_EventType::DROP_BEGIN`] | [`SDL_EVENT_DROP_BEGIN`] | A new set of drops is beginning (NULL filename) |
/// | [`SDL_EventType::DROP_COMPLETE`] | [`SDL_EVENT_DROP_COMPLETE`] | Current set of drops is now complete (NULL filename) |
/// | [`SDL_EventType::DROP_POSITION`] | [`SDL_EVENT_DROP_POSITION`] | Position while moving over the window |
/// | [`SDL_EventType::AUDIO_DEVICE_ADDED`] | [`SDL_EVENT_AUDIO_DEVICE_ADDED`] | A new audio device is available |
/// | [`SDL_EventType::AUDIO_DEVICE_REMOVED`] | [`SDL_EVENT_AUDIO_DEVICE_REMOVED`] | An audio device has been removed. |
/// | [`SDL_EventType::AUDIO_DEVICE_FORMAT_CHANGED`] | [`SDL_EVENT_AUDIO_DEVICE_FORMAT_CHANGED`] | An audio device's format has been changed by the system. |
/// | [`SDL_EventType::SENSOR_UPDATE`] | [`SDL_EVENT_SENSOR_UPDATE`] | A sensor was updated |
/// | [`SDL_EventType::PEN_PROXIMITY_IN`] | [`SDL_EVENT_PEN_PROXIMITY_IN`] | Pressure-sensitive pen has become available |
/// | [`SDL_EventType::PEN_PROXIMITY_OUT`] | [`SDL_EVENT_PEN_PROXIMITY_OUT`] | Pressure-sensitive pen has become unavailable |
/// | [`SDL_EventType::PEN_DOWN`] | [`SDL_EVENT_PEN_DOWN`] | Pressure-sensitive pen touched drawing surface |
/// | [`SDL_EventType::PEN_UP`] | [`SDL_EVENT_PEN_UP`] | Pressure-sensitive pen stopped touching drawing surface |
/// | [`SDL_EventType::PEN_BUTTON_DOWN`] | [`SDL_EVENT_PEN_BUTTON_DOWN`] | Pressure-sensitive pen button pressed |
/// | [`SDL_EventType::PEN_BUTTON_UP`] | [`SDL_EVENT_PEN_BUTTON_UP`] | Pressure-sensitive pen button released |
/// | [`SDL_EventType::PEN_MOTION`] | [`SDL_EVENT_PEN_MOTION`] | Pressure-sensitive pen is moving on the tablet |
/// | [`SDL_EventType::PEN_AXIS`] | [`SDL_EVENT_PEN_AXIS`] | Pressure-sensitive pen angle/pressure/etc changed |
/// | [`SDL_EventType::CAMERA_DEVICE_ADDED`] | [`SDL_EVENT_CAMERA_DEVICE_ADDED`] | A new camera device is available |
/// | [`SDL_EventType::CAMERA_DEVICE_REMOVED`] | [`SDL_EVENT_CAMERA_DEVICE_REMOVED`] | A camera device has been removed. |
/// | [`SDL_EventType::CAMERA_DEVICE_APPROVED`] | [`SDL_EVENT_CAMERA_DEVICE_APPROVED`] | A camera device has been approved for use by the user. |
/// | [`SDL_EventType::CAMERA_DEVICE_DENIED`] | [`SDL_EVENT_CAMERA_DEVICE_DENIED`] | A camera device has been denied for use by the user. |
/// | [`SDL_EventType::RENDER_TARGETS_RESET`] | [`SDL_EVENT_RENDER_TARGETS_RESET`] | The render targets have been reset and their contents need to be updated |
/// | [`SDL_EventType::RENDER_DEVICE_RESET`] | [`SDL_EVENT_RENDER_DEVICE_RESET`] | The device has been reset and all textures need to be recreated |
/// | [`SDL_EventType::POLL_SENTINEL`] | [`SDL_EVENT_POLL_SENTINEL`] | Signals the end of an event poll cycle |
/// | [`SDL_EventType::USER`] | [`SDL_EVENT_USER`] |  Events SDL_EVENT_USER through SDL_EVENT_LAST are for your use, (...) |
/// | [`SDL_EventType::LAST`] | [`SDL_EVENT_LAST`] | *  This last event is only for bounding internal arrays |
/// | [`SDL_EventType::ENUM_PADDING`] | [`SDL_EVENT_ENUM_PADDING`] |  |
#[repr(transparent)]
...
/// | Associated constant | Global constant | Description |
/// | ------------------- | --------------- | ----------- |
/// | [`SDL_EventAction::ADDEVENT`] | [`SDL_ADDEVENT`] | Add events to the back of the queue. |
/// | [`SDL_EventAction::PEEKEVENT`] | [`SDL_PEEKEVENT`] | Check but don't remove events from the queue front. |
/// | [`SDL_EventAction::GETEVENT`] | [`SDL_GETEVENT`] | Retrieve/remove events from the front of the queue. |
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[cfg_attr(feature = "debug-impls", derive(Debug))]
