...
pub const METADATA_SDL_HINT_JOYSTICK_GAMEINPUT_RAW: Hint = Hint {
    module: "hints",
    name: "SDL_HINT_JOYSTICK_GAMEINPUT_RAW",
    short_name: "JOYSTICK_GAMEINPUT_RAW",
    value: crate::hints::SDL_HINT_JOYSTICK_GAMEINPUT_RAW,
    doc: Some(
    ...
    available_since: Some(SDL_VERSIONNUM(3, 4, 4)),
};
...
pub const METADATA_SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK: Hint = Hint {
    module: "hints",
    name: "SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK",
    short_name: "WINDOWS_RAW_KEYBOARD_INPUTSINK",
    value: crate::hints::SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK,
    doc: Some(
