...
pub static METADATA_SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER)
    },
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN)
    },
    ty: SDL_PropertyType::BOOLEAN,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN)
    },
    ty: SDL_PropertyType::BOOLEAN,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_WAYLAND_SURFACE_ROLE_CUSTOM_BOOLEAN: Property =
    Property {
        ...
        value: unsafe {
            CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_WAYLAND_SURFACE_ROLE_CUSTOM_BOOLEAN)
        },
        ty: SDL_PropertyType::BOOLEAN,
        doc: None,
        available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_WAYLAND_CREATE_EGL_WINDOW_BOOLEAN: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_WAYLAND_CREATE_EGL_WINDOW_BOOLEAN)
    },
    ty: SDL_PropertyType::BOOLEAN,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_WAYLAND_WL_SURFACE_POINTER: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_WAYLAND_WL_SURFACE_POINTER)
    },
    ty: SDL_PropertyType::POINTER,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_CREATE_WIN32_PIXEL_FORMAT_HWND_POINTER: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_CREATE_WIN32_PIXEL_FORMAT_HWND_POINTER)
    },
    ty: SDL_PropertyType::POINTER,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_UIKIT_OPENGL_RENDERBUFFER_NUMBER: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_UIKIT_OPENGL_RENDERBUFFER_NUMBER)
    },
    ty: SDL_PropertyType::NUMBER,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_UIKIT_OPENGL_RESOLVE_FRAMEBUFFER_NUMBER: Property = Property {
    ...
    value: unsafe {
        CStr::from_ptr(crate::video::SDL_PROP_WINDOW_UIKIT_OPENGL_RESOLVE_FRAMEBUFFER_NUMBER)
    },
    ty: SDL_PropertyType::NUMBER,
    doc: None,
    available_since: None,
...
pub static METADATA_SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING: Property =
    Property {
        ...
        value: unsafe {
            CStr::from_ptr(crate::video::SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING)
        },
        ty: SDL_PropertyType::STRING,
        doc: None,
        available_since: None,
